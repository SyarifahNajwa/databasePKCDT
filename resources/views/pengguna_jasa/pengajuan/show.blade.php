        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="space-y-6">
                ...
                <div class="flex flex-wrap items-center justify-end gap-3">
                    <a href="{{ route('pengguna-jasa.pengajuan.edit', $penomoran->id) }}" class="inline-flex items-center justify-center rounded-md border border-gray-300 bg-white px-5 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50">
                        Edit
                    </a>
                    <a href="{{ route('pengguna-jasa.pengajuan.index') }}" class="inline-flex items-center justify-center rounded-md bg-blue-600 px-5 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700">
                        Kembali ke Daftar
                    </a>
                </div>
            </div>
