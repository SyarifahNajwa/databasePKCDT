    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('penomoran-form.savePage9', $penomoran->id) }}" id="formReview">
                ...
                <section class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="px-6 py-3 border-b bg-gray-50 flex items-center justify-between">
                        <div>
                            <h3 class="text-sm font-semibold text-gray-700">8. Petugas & Jaminan</h3>
                            <p class="text-xs text-gray-500">Penanggung jawab dan jaminan yang tercatat.</p>
                        </div>
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-gray-700">
                        ...
                        <div class="space-y-2">
                            <p class="text-xs uppercase tracking-wide text-slate-500">Jaminan</p>
